...
namespace TiendaApi.Controllers
{
    ...
    public class TiendaItemsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<TiendaItem>> GetTiendaItem(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutTiendaItem(long id, TiendaItem tiendaItem)
        {
            if (id != tiendaItem.Id)
            {
                return BadRequest();
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<TiendaItem>> DeleteTiendaItem(long id)
        {
            var tiendaItem = await _context.TiendaItems.FindAsync(id);
            if (tiendaItem == null)
            {
        ...
        private bool TiendaItemExists(long id)
        {
